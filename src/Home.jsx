            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <p style={{ color: '#374151' }}>
                  At HealthEdu, we believe that proper health education is a fundamental right for every student. Our platform bridges the gap between traditional learning and modern interactive education.
                </p>
                <div>
                  <a href="#" style={{
                    backgroundColor: '#2563EB',
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{
                      color: '#1E40AF',
                      fontWeight: '500'
                    }}>Interactive Learning Interface</span>
                    <div style={{
                      position: 'absolute',
                      top: '16px',
                      left: '16px',
